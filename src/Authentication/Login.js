            ...
            <div className="container px-4 mx-auto">
                <div className="max-w-sm mx-auto">
                    <div className="mb-6 text-center">
                        <h3 className="mb-4 text-2xl md:text-3xl font-bold">Welcome back</h3>
                      </div>
                    <form action="">
                        ...
                        <div className="mb-6">
                            ...
                            <input
                                ...
                                type="name" placeholder="dev@shuffle.dev" />
                        </div>
                        <div className="mb-4">
                        ...
                        <p className="text-center">
                            <span className="text-xs font-medium">Do not have an account?</span>
