    ...
    <div className="p-4 bg-white rounded shadow-md">
      <div className="relative h-40 w-full mb-4">
        <img
          ...
          alt=""
        />
        <span className="absolute top-0 right-0 py-1 px-2 mt-2 mr-2 bg-indigo-500 rounded text-xs text-white">
          14 Units
        </span>
      </div>
      <div className="flex mb-6 justify-between items-center">
        ...
        <button className="ml-auto p-2 bg-indigo-50 rounded">
          <svg
            width="16"
            height="16"
            viewBox="0 0 16 16"
      ...
      <div className="flex mb-5 justify-between items-center">
        ...
        <span className="text-xs text-indigo-500 font-medium">4</span>
      </div>
      <div className="flex items-ceenter justify-between border-t border-gray-50 pt-4">
        <div className="flex">
          ...
          <img
            ...
            alt=""
          />
          <div className="flex items-center justify-center w-8 h-8 -ml-2 rounded-full bg-indigo-50 text-xs text-indigo-500">
            +3
          </div>
        </div>
        <button className="py-2 px-3 bg-indigo-500 hover:bg-indigo-600 rounded text-xs text-white transition duration-200">
          See Details
        </button>
      </div>
    </div>
