        ...
        <div className="flex flex-wrap items-center">
          ...
          <div className="w-full lg:w-auto lg:ml-auto mb-5 lg:mb-0">
            <div className="flex items-center lg:justify-end">
              <label className="mr-3 text-sm text-gray-500" htmlFor="">
                From
              </label>
              <div className="flex p-2 pl-4 pr-2 bg-white border rounded">
                ...
                <select
                  className="w-full pr-2 text-xs text-gray-500"
                  name=""
                  id=""
                >
              ...
              <label className="mx-3 text-sm text-gray-500" htmlFor="">
                to
              </label>
          ...
          <button className="flex items-center py-2 px-6 rounded bg-color-primary hover:bg-color-secondary text-white text-xs font-medium">
            <span>Load</span>
          </button>
        </div>
      </section>
        ...
        <div className="container px-4 -mx-0">
          <div className="flex flex-wrap -m-3">
            <div className="w-full lg:w-1/2 xl:w-3/4 p-3">
              <div className="p-2 h-full border border-coolGray-100 overflow-hidden bg-white rounded-md shadow-dashboard">
                ...
                <div className="flex flex-wrap justify-between -m-2 mb-2">
                  ...
                  <div className="w-auto  px-4 py-2 shadow-md">
                    <div className="flex flex-wrap items-center -m-1.5">
                      ...
                      <div className="w-auto p-1.5">
                        <p className="flex items-center p-1 px-2 text-xs text-yellow-500 font-medium bg-yellow-100 rounded-full shadow-sm">
                          -7%
                        </p>
                      </div>
                    </div>
            ...
            <div className="w-full lg:w-1/2 xl:w-1/4 p-3 -pr-10">
              <div className="p-6 pb-4 h-full border border-coolGray-100 bg-white rounded-md shadow-dashboard">
                <h2 className="mb-4 text-coolGray-900 text-lg font-semibold">
                  Occupancy Summary
                </h2>
                <div className="flex flex-wrap items-center -m-2 mb-6">
                  <div className="w-auto p-2">
                    <div className="flex items-center justify-center w-4 h-4 bg-red-500 bg-opacity-20 rounded-full">
                      <div className="w-1.5 h-1.5 bg-red-500 rounded-full"></div>
                    </div>
                  </div>
                  <div className="w-auto p-2">
                    <h3 className="text-2xl text-coolGray-900 font-semibold">
                      245
                    </h3>
                    <p className="font-medium text-xs text-coolGray-500">
                      Total Properties
                ...
                <div className="flex flex-wrap justify-between -m-2">
                  ...
                  <div className="w-auto p-2">
                    <p className="text-xs text-coolGray-500 font-semibold uppercase">
                      Number of Units
                    </p>
                  </div>
                </div>
                ...
                <a
                  className="flex justify-center items-center mt-4 text-xs font-medium text-green-500 hover:text-green-600"
                  href="#"
                >
                ...
                <div className="flex flex-wrap items-center justify-between -m-2 mb-6">
                  ...
                  <div className="w-auto p-2">
                    <div className="flex flex-wrap -m-2">
                      <div className="w-auto p-2">
                        <button className="px-3 py-1 text-xs font-medium text-darkCoolGray-500 bg-darkCoolGray-400 rounded-full">
                          Today
                        </button>
                      </div>
                      <div className="w-auto p-2">
                  ...
                  <table className="w-full">
                    <tbody>
                      <tr className="whitespace-nowrap h-11 bg-coolGray-50 bg-opacity-80">
                        ...
                        <th className="whitespace-nowrap px-2 font-semibold text-xs text-coolGray-500 uppercase text-center">
                          Marital Status
                        </th>
                      ...
                      <tr className="h-14 border-b border-coolGray-100">
                        <th className="whitespace-nowrap px-4 bg-white text-left">
                          <div className="flex items-center -m-2">
                            <div className="w-auto p-1">
                              <div className="flex items-center justify-center w-10 h-10 text-base font-medium rounded-md">
                                <img
                                  src="https://images.unsplash.com/photo-1582152629442-4a864303fb96?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8c2VsZmllfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60"
                        ...
                        <th className="whitespace-nowrap px-1.5 bg-white text-sm font-medium text-coolGray-800 text-center">
                          4
                        </th>
                        ...
                        <th className="whitespace-nowrap px-4 bg-white text-sm font-medium text-green-500 text-center">
                          <div className="flex items-center justify-center p-5 h-20 min-w-max border-b border-gray-100">
                            <a
                              className="inline-flex w-8 h-8 mr-2 items-center justify-center bg-white shadow-xl rounded-2xl"
                              href="#"
                            >
                              <AiOutlineCheck />
                            </a>
