      ...
      <nav>
        <div className="relative flex items-center">
          <div className="flex items-center mr-auto">
            <button className="flex py-2 px-6 rounded bg-color-primary hover:bg-color-secondary text-white text-sm">
          ...
          <div className="flex justify-end lg:hidden">
            <button className="flex items-center">
              <svg
                className="text-indigo-500 bg-indigo-100 block h-8 w-8 p-2 rounded"
                viewBox="0 0 20 20"
                xmlns="http://www.w3.org/2000/svg"
                fill="currentColor"
              >
          ...
          <div className="hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 lg:flex lg:w-auto lg:space-x-10">
            <div className="hidden lg:flex items-center mr-auto pl-4 border rounded">
              ...
              <input
                className="pl-2 py-3 px-10 rounded-md text-sm text-gray-200"
                type="text"
          ...
          <div className="hidden lg:block">
            <button className="flex items-center">
              <img
                className="w-10 h-10 mr-2 rounded-full object-cover object-right"
