...
function Home(props) {
  return (
    <>
      <section className="relative bg-color-secondary bg-opacity-90 background-animate overflow-hidden">
        <section>
          <div className="flex items-center justify-between px-8 py-5">
            ...
            <div className="w-auto hidden lg:block">
              <ul className="flex items-center mr-10">
                <li className="font-heading mr-9 text-color-main hover:text-gray-200 text-lg">
                  <a href="#">Features</a>
                </li>
                <li className="font-heading mr-9 text-color-main hover:text-gray-200 text-lg">
                  <a href="#">Solutions</a>
                ...
                <li className="font-heading text-color-main hover:text-gray-200 text-lg">
                  <a href="#">Pricing</a>
                </li>
              </ul>
            </div>
            <div className="w-auto">
              <div className="flex flex-wrap items-center">
                <div className="w-auto hidden lg:block">
                  <a
                    href="/signup"
                    className="font-heading block py-3.5 px-5 uppercase text-xs tracking-px text-white font-bold bg-white bg-color-main hover:bg-opacity-10 transition ease-in rounded-10"
                  >
                    Start Free Trial
                  </a>
                </div>
          ...
          <div className="flex flex-wrap justify-center items-center pt-32">
            <div className="w-auto">
              ...
              <p className="mb-9 font-medium text-lg text-center text-white">
                We offer the best real estate management platform to easily
              ...
              <div className="flex flex-wrap justify-center items-center mb-7 -m-1.5">
                ...
                <div className="w-full lg:w-auto p-1.5">
                  <button className="group relative font-heading px-6 py-5 w-full lg:w-auto uppercase text-white text-xs font-semibold tracking-px bg-gray-900 hover:bg-gray-800 overflow-hidden rounded-md">
                    <div className="absolute top-0 left-0 transform -translate-x-full group-hover:-translate-x-0 h-full w-full transition ease-in-out duration-500 bg-color-main"></div>
                    <p className="relative z-10">Start free trial</p>
                  </button>
                </div>
              </div>
              ...
              <img
                ...
                src="https://static.shuffle.dev/uploads/files/3a/3a2d88582d983fc52d1e7b2df050211c32598f8d/Screenshot-2022-08-10-210957.png"
                alt=""
              />
            </div>
          </div>
